...
<html lang="en">
	...
	<body id="body-pd">
		<header class="header" id="header">
			...
			<h3>miraz's Portfolio</h3>
			<div class="header_img"> <img src="logo.jpg" alt=""> </div>
		</header>
		<div id="container">
	...
	<div class="content">
			...
			<div id="tab-aboutMe" class="tab">
			<div class="height-100 bg-light">
			<?php
			include 'resources/aboutMe.php';
			?>
			</div>
			</div>
			
			<div id="tab-timeline" class="tab" style="display: none;">
			<div class="height-100 bg-light">
			<?php
			include 'resources/timeline.php';
			?>
			</div>
			</div>

			<div id="tab-project" class="tab" style="display: none;">
			<div class="height-100 bg-light">
			<?php
			...
			<div id="tab-travelling" class="tab" style="display: none;">
			<div class="height-100 bg-light">
			<?php
			include 'resources/travelling.php';
			?>
			</div>
			</div>

			<div id="tab-contact" class="tab" style="display: none;">
			<div class="height-100 bg-light">
			<?php
